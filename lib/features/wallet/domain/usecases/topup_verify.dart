...
class TopupVerifyUseCase {
  const TopupVerifyUseCase(this._repository);

  final WalletRepository _repository;

  Future<Either<Failure, WalletEntity>> call(WalletTopupVerifyParams params) {
    return _repository.topupVerify(params);
  }
}
